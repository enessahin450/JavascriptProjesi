...
const render= () => {
    drawRect(0,0,cvs.width,cvs.height,'#ffff00')
    drawRect(cvs.width/2-2,0,4,cvs.height,'#000099')
    drawCircleF(cvs.width/2,cvs.height/2,8,'#000099')
    drawCircleS(cvs.width/2,cvs.height/2,50,4,'#000099')
    drawText(user.score,cvs.width/4,100,'#333300')
    drawText(com.score,3*cvs.width/4,100,'#333300')
